        ...
        if (requisicao.method === "POST") {
            if (requisicao.is("application/json")) {
                ...
                if (nome && descricao) {
                    ...
                    resposta.json({
                        "status": false,
                        "mensagem": "Verifique a documentação da API e informe todos os dados necessários de uma categoria!"
                    });
                }
            } else {
                resposta.json({
        ...
        if (requisicao.method === "DELETE") {
            if (requisicao.is("application/json")) {
                ...
                if (id) {
                    ...
                    resposta.json({
                        "status": false,
                        "mensagem": "Especifique na URL o ID da categoria que deseja excluir!"
                    });
                }
            } else {
                resposta.json({
    ...
    async consultarID(requisicao, resposta) {
        ...
        if (requisicao.method === "GET") {
            ...
            if (id) {
                ...
                resposta.json({
                    "status": false,
                    "mensagem": "Especifique na URL o ID da categoria que deseja consultar!"
                });
            }
        } else {
            resposta.json({
